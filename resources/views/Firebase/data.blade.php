      ...
      <td>
        <div class="dropdown">
          ...
          {{-- <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#largeModal{{$p->id}}"
            ...
            <a class="dropdown-item ssedtt" href="/DataLink/Firebase/edit/{{$p->id}}"
                  ...
                  <div class="modal fade" id="tambahModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <form  method="POST" action="/DataLink/Firebase/save" enctype="multipart/form-data">
                          @csrf
                        ...
                        <div class="d-flex align-items-start align-items-sm-center mb-3 gap-4">
                            ...
                            <div class="col mb-0">
                              ...
                              <select name="id_user" class="select2 form-select">
  ...
  buttonsStyling: false
          ...
          if (result.isConfirmed) {
              $.ajax({
                  ...
                  url: '/DataLink/Firebase/hapus/' + id,
                  data: {
                      _token: '{{ csrf_token() }}'
                  },
