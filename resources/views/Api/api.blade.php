                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Get By username.</td>
                                        <td>https://vmush.site/api/Data/Permintaan/data-tampil/{user}</td>
                                         <td><span class="badge bg-label-primary me-1">Active</span></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Get By username.</td>
                                        <td>https://vmush.site/api/Data/Permintaan/data-tampil/id/{id_stok}</td>
                                         <td><span class="badge bg-label-primary me-1">Active</span></td>
                                    </tr>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td>4</td>
                                        <td>Edit Data</td>
                                        <td>https://vmush.site/api/Data/Permintaan/edit-Data/id/{id_stok}</td>
                                         <td><span class="badge bg-label-primary me-1">Active</span></td>
                                    </tr>
                                   ...
                                   <tr>
                                        <td>5</td>
                                        <td>Delete Data</td>
                                        <td>https://vmush.site/api/Data/Permintaan/hapus-Data/user/{username}</td>
                                         <td><span class="badge bg-label-primary me-1">Active</span></td>
                                    </tr> 
