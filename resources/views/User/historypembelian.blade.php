...
@foreach($main as $item)
    <tr>
      ...
      <td class="p-3">{{$item->id_sewa}}</td>
      <td>{{$item->nama_paket}}</td>
      <td>{{$item->nama}}</td>

     <td>
  @if($item->status_sewa == 'Berhasil')
    <span class="badge bg-success">Berhasil</span>
  @elseif($item->status_sewa == 'Ditolak')
  ...
  @endif
      ...
      <td>
        <div class="dropdown">
          ...
          <div class="dropdown-menu">
          <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#largeModal{{$item->id_sewa}}"
              >
              <i class="ti ti-list-details me-1"></i></i> Detail Data</button>
            {{-- <a class="dropdown-item ssedtt" href="/dashboard/admin/Pembelian/paket-edit/{{$item->id_sewa}}"
...
<!-- Detail Modal -->
                  @foreach($main as $item)
                  <div class="modal fade" id="largeModal{{$item->id_sewa}}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center mb-3 gap-4">
                    <img
                      src="{{$item->gambar_sewa}}"
                      alt="user-avatar"
                      class="d-block w-px-100 h-px-100 rounded"
                      id="uploadedAvatar" />
<a target="__blank" href="{{$item->gambar_sewa}}" class="btn btn-primary mb-3">
                        ...
                        <span class="d-none text-white d-sm-block">Bukti Pembayaran</span>
                          ...
                          <div class="row">
                            <div class="col mb-3">
                              ...
                              <input type="text" readonly class="form-control" placeholder="" value="{{$item->nama_paket}}" />
                            </div>
                          </div>
                          <div class="row g-2 mb-3">
                            <div class="col mb-0">
                              <label for="dobLarge" class="form-label">nama</label>
                              <input type="text" readonly class="form-control" placeholder="" value="{{$item->nama}}" />
                            </div>
                            {{-- <div class="col mb-0">
                              <label for="emailLarge" class="form-label">Email</label>
                              <input type="email" value="{{$item->email}}" readonly class="form-control" placeholder="" />
                            </div> --}}
                          </div>
                          ...
                          <div class="col mb-0">
                              ...
                              <input type="number" value="62{{$item->nohp}}" readonly class="form-control" placeholder="" />
                            </div>
                            <div class="col mb-0">
                              <label for="emailLarge" class="form-label">alamat</label>
                              <input type="text" value="{{$item->alamat}}" readonly class="form-control" placeholder="" />
                            </div>
                            ...
                            <div class="col mb-0">
                              ...
                              <input type="text" value="{{$item->status_sewa}}" readonly class="form-control" placeholder="" />
                            </div>
                            <div class="col mb-0">
                              <label for="emailLarge" class="form-label">Tanggal Pembelian</label>
                              <input type="text" class="form-control" value="{{$item->tanggal_pembelian}}" readonly placeholder="" />
                            </div>
                            </div>
