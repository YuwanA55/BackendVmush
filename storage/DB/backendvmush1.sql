...
--
-- Host: localhost:3306
-- Generation Time: May 17, 2025 at 03:22 PM
...
CREATE TABLE `akun_user` (
  `username` varchar(10) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci NOT NULL,
  `nama` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci NOT NULL,
  `password` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `pwasli` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `status` varchar(10) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `gambar` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `alamat` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `nohp` varchar(15) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `tanggal_create` datetime DEFAULT NULL,
  `status_akun` varchar(20) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=COLLATE=utf8mb4_general_ci;
...
INSERT INTO `bank` (`id`, `nama`, `bank`, `norek`, `tanggal_create`) VALUES
...
CREATE TABLE `firebase` (
  `id` varchar(20) NOT NULL,
  `username` varchar(200) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `paket` (
  ...
  `nama_paket` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `harga` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `jumlah_sensor` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `kontrol_app` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `support` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `analisisdata` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `konsultasi` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `gambar` varchar(250) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `pembelian` (
  `id` varchar(20) NOT NULL,
  `id_paket` varchar(20) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `penjadwalan` (
  `id_penjadwalan` varchar(20) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci NOT NULL,
  `username` varchar(150) NOT NULL,
  `tanggal` date NOT NULL,
  `keterangan` varchar(150) NOT NULL,
  `sub_keterangan` varchar(250) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `permintaan_stok` (
  `id_stok` varchar(10) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `id_tengkulak` varchar(10) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `jumlah_stok` varchar(10) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `tanggal` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tengkulak` (
  `id_tengku` varchar(10) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `username` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `nama` varchar(250) NOT NULL,
  `password` varchar(150) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `alamat` varchar(200) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
  `nohp` varchar(20) CHARACTER SET utf8mb4 COLLATE COLLATE=utf8mb4_general_ci DEFAULT NULL,
