                 ...
                 <div class="modal fade" id="tambahModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <form  method="POST" action="/dashboard/admin/databank/data-save" enctype="multipart/form-data">
                          @csrf
                        ...
                        <div class="d-flex align-items-start align-items-sm-center mb-3 gap-4">
                            ...
                            <div class="col mb-3">
                              <label for="dobLarge" class="form-label">Nama Bank</label>
                              <select name="bank" class="select2 form-select">
                          ...
                          <div class="row g-2 mb-2 mt-2">
                            <label for="exampleFormControlTextarea1">No Rekening</label>
                            <input type="number" name="norek" class="form-control mt-1 mb-4" rows="3"> </input>
                            </div>
  ...
  buttonsStyling: false
          ...
          if (result.isConfirmed) {
              $.ajax({
                  ...
                  url: '/dashboard/admin/databank/hapus/' + id,
                  data: {
                      _token: '{{ csrf_token() }}'
                  },
                  success: function(response) {
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = "{{ route('databank') }}";
                        });
                    }
                },
