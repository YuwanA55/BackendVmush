                      ...
                      <div class="d-flex align-items-start align-items-sm-center mb-2 gap-4">
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 ">
                            ...
                            <select name="id_user" placeholder=""  class="select2 form-select">
                              
                            {{-- <option value="{{$main->id}}">{{$main->nama}}</option> --}}
                            {{-- <option hidden value=""></option> --}}
                            {{-- @foreach ($alluser as $p) --}}
                        
                            <option value="{{$main->id_user}}">{{$main->nama}}</option>
                            {{-- @endforeach --}}
                                </select>
                          </div>
                        ...
                        <div class="mt-5 text-end">
                          ...
                          <a class="btn btn-danger" href="/DataLink/Firebase">Kembali </a>
